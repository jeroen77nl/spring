...
@SpringBootApplication is a convenience annotation that adds all of the following:
	...
	@EnableAutoConfiguration:
		Tells Spring Boot to start adding beans based on classpath settings, other beans,
...
public class DemoWsServerApplication {

	public static void main(String[] args) {
		SpringApplication.run(DemoWsServerApplication.class, args);
	}
